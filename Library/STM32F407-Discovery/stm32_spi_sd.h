...
#define SD_SPI_MOSI_PIN                  GPIO_Pin_7                  /* PA7 */
#define SD_SPI_MOSI_GPIO_PORT            GPIOA                       /* GPIOA */
#define SD_SPI_MOSI_GPIO_PIN_SOURCE      GPIO_PinSource7            /* 7 */
#define SD_SPI_MOSI_GPIO_CLK             RCC_AHB1Periph_GPIOA


#define SD_SPI_SCK_PIN                   GPIO_Pin_5                  /* PA5 */
#define SD_SPI_SCK_GPIO_PORT             GPIOA                       /* GPIOA */
#define SD_SPI_SCK_GPIO_PIN_SOURCE       GPIO_PinSource5             /* 5 */
#define SD_SPI_SCK_GPIO_CLK              RCC_AHB1Periph_GPIOA

#define SD_SPI_MISO_PIN                  GPIO_Pin_6                  /* PA6 */
#define SD_SPI_MISO_GPIO_PORT            GPIOA                       /* GPIOA */
#define SD_SPI_MISO_GPIO_PIN_SOURCE      GPIO_PinSource6             /* 6 */
#define SD_SPI_MISO_GPIO_CLK             RCC_AHB1Periph_GPIOA


#define SD_SPI_CS_PIN                    GPIO_Pin_4                 /* PA4 */
#define SD_SPI_CS_GPIO_PORT              GPIOA                     /* GPIOA */
#define SD_SPI_CS_GPIO_CLK               RCC_AHB1Periph_GPIOA


#define SD_DETECT_PIN                    GPIO_Pin_2                  /* PD2 */
...
/** 
  ...
  */  
#define SD_CS_LOW()     GPIO_ResetBits(SD_SPI_CS_GPIO_PORT, SD_SPI_CS_PIN)
/** 
  * @brief  Deselect SD Card: ChipSelect pin high   
  */ 
#define SD_CS_HIGH()    GPIO_SetBits(SD_SPI_CS_GPIO_PORT, SD_SPI_CS_PIN)
/**
  * @}
  */ 
